...
namespace ShopListImplement.Implements
{
    public class ShopStorage : IShopStorage
    {
        ...
        public List<ShopViewMode> GetFullList()
        {
            var result = new List<ShopViewMode>();
            foreach (var shop in _source.Shop)
            {
                result.Add(shop.GetViewModel);
            }
            return result;
        }
        public List<ShopViewMode> GetFilteredList(ShopSearchModels model)
        {
            var result = new List<ShopViewMode>();
